...
const getSurvivorCountForClass = (data, pclass) => {
  /* Filtering the data for passengers that have a pclass that matches the pclass passed in and a
survived property of "Yes". It then returns the length of the array. */
  return data.filter(
    (passenger) =>
